	...
	<view class="uni-combox" :class="border ? '' : 'uni-combox__no-border'">
		...
		<view class="uni-combox__input-box">
			<input class="uni-combox__input" type="text" :placeholder="placeholder" placeholder-class="uni-combox__input-plac"
				v-model="inputVal" @input="onInput" @focus="onFocus" />
		...
		<view class="uni-combox__selector" v-if="showSelector">
			...
			<scroll-view scroll-y="true" class="uni-combox__selector-scroll">
				...
				<view class="uni-combox__selector-item" v-for="(item,index) in filterCandidates" :key="index"
					@click="onSelectorClick(index)" @touchstart="handleSelectorItemTouchStart">
					<text>{{item}}</text>
				</view>
			</scroll-view>
		</view>
		...
		methods: {
			toggleSelector() {
				...
				if (this.showSelector) {
					this.selectorInteraction = false;
				}
			},
			onFocus() {
			...
			handleSelectorItemTouchStart() {
				this.selectorInteraction = true
			}
		}
	}
</script>
